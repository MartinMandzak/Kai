...
'''
The idea here was to change the step size as the model was learning to truly hone in on the accuracy.
I was trying to avoid getting stuck in local minimum of the function. 
'''
...
'''
get_features follows a basic RFM model
nothing too fancy, just standard stuff
'''
...
# was expecting a gamma distribution hence the uneven outliers
...
'''
This function has been a 2am Redbull sponsored fever dream that spits out a lot more things than I really needed.
Some of these values haven't been used in the final thesis.
Some have.
Though in general we had mean error and R^2 score as main performance metrics.
Do not ask me why the graphs are the way they are for I do not know anymore...
'''
...
clr =CyclicLR(base_lr = 0.000069, max_lr = 0.00069) # Yes, I thought I was being fucking hilarious with those values
...
churn_preds_class = (churn_preds > 0.95).astype(int)
